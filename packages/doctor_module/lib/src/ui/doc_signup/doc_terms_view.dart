...
class DocTermsView extends StatefulWidget {
  final String? getcontent;
  DocTermsView({Key? key, this.getcontent}) : super(key: key);

  @override
  State<DocTermsView> createState() => _DocTermsViewState();
}

class _DocTermsViewState extends State<DocTermsView> {
                ...
                Expanded(
                  ...
                  child: Stack(
                    children: [
                      ...
                      // InAppWebView(
                      //   key: webViewKey,
                      //  // initialUrlRequest: URLRequest(url: Uri.parse("<body><p>new</p></body>")),
                      //   initialFile: ck, 
