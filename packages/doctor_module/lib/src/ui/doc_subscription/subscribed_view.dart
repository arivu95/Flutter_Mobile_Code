...
class DocSubscribedView extends StatefulWidget {
  DocSubscribedView({Key? key}) : super(key: key);

  @override
  _DocSubscribedViewState createState() => _DocSubscribedViewState();
}

class _DocSubscribedViewState extends State<DocSubscribedView> {
