...
class DicomFolderViewmodel extends BaseViewModel {
 ...
 //fileList = 
  Future getFoldersByCategory(String catId) async {
    setBusy(true);
    String userId = preferencesService.dropdown_user_id;
    fileList = await apiService.getDicomFoldersByCategory(userId, catId);
    print(fileList);
...
Future getDicomFilesByCategory(String catId, String filename) async {
    setBusy(true);
    String userId = preferencesService.dropdown_user_id;
    fileList = await apiService.getDicomFilesByCategory(userId, catId,filename);
    print(fileList);
...
Future getFilteredFilesByCategory(String catId,String cattitle,dynamic data) async {
    ...
    String userId = preferencesService.dropdown_user_id;
     ...
     if(cattitle=="Maternity"){
        fileList = temp.where((e) {
      return e['fileCategory'].toString().toLowerCase().contains("Maternity".toLowerCase())
      && e['filter_title1'].toString().toLowerCase().contains(data['title1'].toLowerCase());
     }).toList();
     }
     ...
     if(cattitle=="Covid Test"){
        fileList = temp.where((e) {
      return e['fileCategory'].toString().toLowerCase().contains("Covid Test".toLowerCase())
      && e['filter_title1'].toString().toLowerCase().contains(data['title1'].toLowerCase());
    }).toList();
     }
