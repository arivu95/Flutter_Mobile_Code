...
class FilteredDownloadDetailView extends StatefulWidget {
  final String categoryId;
  final String categoryTitle;
  dynamic data;
  FilteredDownloadDetailView({Key? key, required this.categoryId, required this.categoryTitle, required this.data}) : super(key: key);

  @override
  _FilteredDownloadDetailViewState createState() => _FilteredDownloadDetailViewState();
}

class _FilteredDownloadDetailViewState extends State<FilteredDownloadDetailView> {
              ...
              FlatButton(
                ...
                onPressed: () async {
                  if (valueText == "") {
                    ...
                    model.getFilteredFilesByCategory(widget.categoryId, widget.categoryTitle, widget.data);
                    valueText = "";
                  }
                },
              ),
...
// child:
  ...
  Widget build(BuildContext context) {
    if (locator<PreferencesService>().isReload.value == true) {
      modelRef.getFilteredFilesByCategory(widget.categoryId, widget.categoryTitle, widget.data);
      locator<PreferencesService>().isReload.value = false;
    }
    return Scaffold(
