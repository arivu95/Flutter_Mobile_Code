...
//     }
    ...
    //   attach_file_name = widget.maternityinfo['attach_record'].contains('/') ? widget.maternityinfo['attach_record'].split('/').last : widget.maternityinfo['attach_record'];
    // } else {
    //   attach_file_name = "";
    // }

    if (preferencesService.dropdown_user_dob != null) {
      // Jiffy dob_chk = Jiffy(preferencesService.dropdown_user_dob);
      // get_dob = dob_chk.format('dd/MM/yyyy');
                  ...
                  child: Column(
                    children: [
                      ...
                      additionalInfoWidget(
                          context,
                          'Age',
//                           preferencesService.memberInfo['age']!=null || preferencesService.memberInfo['age']!=""
// ?                        preferencesService.memberInfo['age'].toString() : "",
//                        preferencesService.dropdown_user_age!=null || preferencesService.dropdown_user_age!=""
// ?                      preferencesService.dropdown_user_age.toString() : "",
                      ...
                      (widget.maternityinfo['baby_blood_group'] == null) || (widget.maternityinfo['baby_blood_group'] == '')
                          ? additionalInfoWidget(context, ' Mother BloodGroup ', '', imageItem('assets/bbgroup.png'))
                          : additionalInfoWidget(context, ' Mother BloodGroup', widget.maternityinfo['baby_blood_group'], imageItem('assets/bbgroup.png')),
                      //UIHelper.verticalSpaceSmall,
                      UIHelper.verticalSpaceMedium,
                      // additionalInfoWidget(
                      //     context,
