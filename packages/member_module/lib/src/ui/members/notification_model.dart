...
class Notificationmodel extends BaseViewModel {
  ...
  Future<bool> acceptinvite(String feedId, String refId, String status) async {
    setBusy(true);
    String userId = preferencesService.userId;
    bool response = await apiService.acceptinvite(userId, refId, feedId, status);
    setBusy(false);
    return response;
  }

  Future<bool> docacceptinvite(String feedId, String refId, String status) async {
    setBusy(true);
    String userId = preferencesService.userId;
    bool response = await apiService.Doctoracceptinvite(userId, refId, feedId, status);
    setBusy(false);
    return response;
  }
