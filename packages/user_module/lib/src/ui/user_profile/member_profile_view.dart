...
class ViewMemberProfileView extends StatefulWidget {
  final String memberId, view_type;

  ViewMemberProfileView({Key? key, required this.memberId, required this.view_type}) : super(key: key);

  @override
  _ViewMemberViewState createState() => _ViewMemberViewState();
}

class _ViewMemberViewState extends State<ViewMemberProfileView> {
  ...
  String cover_url = '';
  String isvideo = '';
 MembersViewmodel modelRef = MembersViewmodel();
  ...
  Widget build(BuildContext context) {
     if (locator<PreferencesService>().isReload.value == true) {
      locator<PreferencesService>().isReload.value = false;
       modelRef.getMemberProfile(widget.memberId);
    }
    return 
       Expanded(
        child:
